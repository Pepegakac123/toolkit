...
// ReadJSON tries to read the body of teh req and converts it from json into go data variable
...
// WriteJSON takes a response status code and arbitrary data and writes json to client
